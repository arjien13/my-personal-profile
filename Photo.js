...
newFolder.addEventListener('mouseout', () => {
  newFolder.style.transform = 'scale(1)';
      ...
      folderName.style.fontFamily = 'cursive';
      ...
      // Function to display video folders
...
if (!folder.photos || folder.photos.length === 0) {
      ...
      // Add event listener to upload photos
        ...
        uploadInput.addEventListener('change', (e) => {
          ...
          for (const file of files) {
            ...
            reader.onload = () => {
              ...
              // Update the folder contents display
      ...
      folder.photos.forEach((photo) => {
        ...
        // Add event listener to display original photo
...
closeButton.addEventListener('click', () => {
  document.body.removeChild(folderContents);
       ...
       // this is for delete button section
          const deleteButton = document.createElement('button');
         ...
         deleteButton.addEventListener('mouseover', () => {
          ...
          deleteButton.addEventListener('mouseout', () => {
           ...
           deleteButton.addEventListener('click', () => {
            ...
            confirmDialog.style.color = '#fff'; // optional, for better text visibility
...
addMoreButton.style.transition = 'transform 0.2s ease-in-out';
addMoreButton.style.background = 'rgba(0, 0, 0, 0.3)';
